...
function call(method, pathname, body) {
  return new Promise((resolve, reject) => {
    ...
    timer = setTimeout(() => {
      req.destroy(Object.assign(new Error(`Relay HTTP response timed out after ${timeoutMs}ms; delivery is unknown, do not automatically resend`), { code: 'RELAY_RESPONSE_TIMEOUT' }));
    }, timeoutMs);
